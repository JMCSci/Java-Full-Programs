...
// Transaction object uses balance variable from argument constructor
	double withdraw(double withdrawalAmount, char W, int option) {
		// ## CHECKING ## // 
		if(option == 1) {
...
// Transaction object uses balance variable from argument constructor
	double deposit(double depositAmount, char D, int option) {
		// ## CHECKING ## //
		if(option == 1) {
	...
	// Transaction object uses balance variable from argument constructor
		double transfer(double transferAmount, char T, int option) {
			// ## CHECKING ## //
			if(option == 1) {
