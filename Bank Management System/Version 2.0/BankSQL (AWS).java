/* BankSQL class connects to MySQL database/Amazon Relational Database Serive (RDS)
...
public class BankSQL extends Bank {
	...
	/* Connect to database */
		Connection conn = DriverManager.getConnection("jdbc:mysql://-------------------------.rds.amazonaws.com:----/BankDB?serverTimezone=EST", "username" , "password");
	...
	public void idCountBackup(int idCount) throws SQLException, ClassNotFoundException {
		Class.forName("com.mysql.cj.jdbc.Driver");
		Connection conn = DriverManager.getConnection("jdbc:mysql://-------------------------.amazonaws.com:----/BankDB?serverTimezone=EST", "username" , "password");
